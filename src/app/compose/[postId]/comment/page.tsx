			...
			<article className="rounded-lg border p-4 max-w-[440px]">
              ...
              />
							...
							<div className="flex items-center justify-center gap-2">
								...
								<button className="bg-blue-400 text-white py-1 px-2.5 rounded-md disabled:bg-blue-200 disabled:cursor-not-allowed" disabled={text.length < 1 && selectedFiles.length === 0} onClick={handlePost} ref={buttonRef}>Comment</button>
							</div>
						</div>
					</>
				) : (
