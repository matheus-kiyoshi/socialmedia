        ...
        {data.length === 1 ? (
          ...
          <>
            <tr className="rounded-2xl">
              <td
                rowSpan={data.length === 2 ? 2 : 1}
                className={`h-28 w-1/2 hover:opacity-80 relative ${
                  data.length < 3 && 'rounded-2xl'
                }`}
              >
                <button
                  onClick={() => handleClose(0)}
            ...
            <tr>
              {data.length > 2 && (
                <td
                  colSpan={data.length === 3 ? 2 : 1}
                  className="h-28 hover:opacity-80 relative"
                >
                  <button
                    onClick={() => handleClose(0)}
                    className="absolute top-2 right-2"
