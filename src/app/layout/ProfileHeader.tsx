...
export default function ProfileHeader({user}: {user: User}) {
	...
	return (
		<header className={`grid-area-header bg-white ${scrollY > 80 ? 'bg-opacity-80 border-b backdrop-blur-sm' : 'bg-opacity-60'} w-full sm:w-[558px] fixed top-0 z-20 h-16 flex items-center justify-between px-2`}>
