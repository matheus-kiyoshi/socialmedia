		...
		<nav className="hidden z-20 top-0 bg-white border-r-2 sm:flex sm:sticky flex-col justify-between h-screen items-end py-6 px-4">
			...
			{session.data && (	
				<>
					...
					<button className="py-2 pr-1 lg:px-4 rounded-3xl hover:bg-zinc-100 flex items-center justify-center gap-2" aria-describedby={idButton} type="button" onClick={handleClick}>
